...
bool loadModel(const char* fileName)
{
    ...
    animationScene = aiImportFile("Models/Mannequin/run.fbx", aiProcessPreset_TargetRealtime_MaxQuality);
...
void display()
{
    ...
    gluLookAt((posn.x - xc + look_radius) * tmp, 0, (posn.z - zc + look_radius) * tmp, (posn.x - xc) * tmp, 0, (posn.z - zc) * tmp, 0, 1, 0);
